        ...
        <div class="container">
            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >{{ __("Add New nurse") }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="qualification" wire:model.lazy="qualification"  placeholder="Enter qualification" class="form-control"   />
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >{{ _("All  nurses") }}</div>
                        ...
                        <tbody>
                            @forelse ($nurses as $nurse)
                                <tr>
                                    ...
                                    <td><img width="100%" height="70px" src="{{env('APP_URL').'storage/'. $nurse->photo_path }}" alt=""></td>
                                    <td>{{ $nurse->created_at }}</td>
                                    <td class="text-right">
                                        <button wire:click="edit({{ $nurse->id }})" class="btn btn-outline-info btn-rounded"><i class="fas fa-pen"></i></button>
                                        <button wire:click="delete({{ $nurse->id }})" onclick="return confirm('{{ __('Are You Sure ?')  }}')" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
