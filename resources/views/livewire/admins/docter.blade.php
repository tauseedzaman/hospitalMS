                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_doctor()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Password" name="Password" wire:model.lazy="Password"
                                placeholder="{{ __('Create New Password ') }}" class="form-control" />
                            @error('Password')
                                <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Specialization" wire:model.lazy="Specialization"
                        ...
                        <tbody>
                            @forelse ($doctors as $doctor)
                                <tr>
                                    ...
                                    <td><img width="100%" height="70px" src="{{ $doctor->photo_path }}"
                                            alt=""></td>
                                    <td class="text-right">
