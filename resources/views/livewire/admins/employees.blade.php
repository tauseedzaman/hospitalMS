                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_employee()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" wire:model.lazy="name"
                                placeholder="Enter Employee Name" class="form-control" required cols="30"
                                rows="5"></textarea>
                        </div>
                        @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="Email" wire:model.lazy="email"
                                placeholder="Enter Employee Email" class="form-control" required cols="30"
                                rows="5"></textarea>
                        </div>
                        @error('email')
                            <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Address" wire:model.lazy="address"
                                placeholder="Enter Employee Address" class="form-control" required cols="30"
                                rows="5"></textarea>
                        </div>
                        @error('address')
                            <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
