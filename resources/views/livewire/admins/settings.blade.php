                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="general" role="tabpanel"
                                ...
                                <form accept-charset="utf-8" class="shadow rounded p-3"
                                    wire:submit.prevent="add_settings()">
                                    ...
                                    <div class="col-md-8 m-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="example@test.com"
                                                wire:model.lazy="business_email" name="email"
                                                class="form-control"">
                                        ...
                                        <div class="form-group">
                                            <label for="working_horse" class="form-control-label">Working
                                                Horse</label>
