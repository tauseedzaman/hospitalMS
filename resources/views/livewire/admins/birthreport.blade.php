        ...
        <div class="container">
            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >{{ __("Add New BirthReport") }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="Details" id="Details" wire:model.lazy="details" placeholder="Enter Birth Details" class="form-control" required cols="30" rows="5"></textarea>
                    </div>
                    @error('details') <span class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >{{ _("All  BirthReports") }}</div>
                        ...
                        <tbody>
                            @forelse ($BirthReports as $BirthReport)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <button wire:click="edit({{ $BirthReport->id }})" class="btn btn-outline-info btn-rounded"><i class="fas fa-pen"></i></button>
                                        <button wire:click="delete({{ $BirthReport->id }})" onclick="return confirm('{{ __('Are You Sure ?')  }}')" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
